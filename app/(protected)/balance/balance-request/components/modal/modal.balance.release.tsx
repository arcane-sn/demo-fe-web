    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-[540px]">
        ...
        <DialogBody className="flex flex-col gap-4 max-h-[60vh] overflow-y-auto">
          <div className="min-h-[60px] self-stretch px-3.5 py-4 bg-yellow-50 rounded-md  outline-1 outline-offset-[-1px] outline-yellow-500 inline-flex flex-col justify-start items-start gap-2.5 overflow-hidden">
              ...
              <div className="self-stretch px-3.5 pt-2.5 pb-3.5 bg-stone-50 rounded-md outline-1 outline-offset-[-1px] outline-slate-300 flex flex-col justify-start items-start gap-2.5">
                <div className="self-stretch inline-flex justify-start items-start gap-2.5">
                  <div className="flex-1 inline-flex flex-col justify-start items-start gap-1.5">
                    ...
                    <div className="justify-start text-emerald-600 text-2xl font-semibold font-['Inter'] leading-normal">
                      + IDR 15.000.000
                    </div>
                  </div>
                </div>
          ...
          <Card className="w-full self-stretch">
            ...
            <CardContent className="px-7 pb-7 flex flex-col gap-6">
              <div className="self-stretch flex flex-col justify-start items-start gap-6">
                ...
                <div className="self-stretch flex flex-col justify-start items-start gap-4">
                  ...
                  <div className="self-stretch inline-flex justify-start items-start gap-2.5">
                    ...
                    <div className="justify-start text-emerald-600 text-sm font-medium font-['Inter'] leading-none">
                      + IDR 45.000.000
                    </div>
                  </div>
                </div>
              ...
              <div className="self-stretch flex flex-col justify-start items-start gap-6">
                ...
                <div className="self-stretch flex flex-col justify-start items-start gap-4">
                  ...
                  <div className="self-stretch inline-flex justify-start items-start gap-2.5">
                    ...
                    <div className="justify-start text-rose-500 text-sm font-medium font-['Inter'] leading-none">
                      - IDR 30.000.000
                    </div>
                  </div>
                </div>
