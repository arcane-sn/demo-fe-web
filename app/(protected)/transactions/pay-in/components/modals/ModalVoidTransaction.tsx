...
import { ModalVoidTransactionProps } from "../../core/_models";

const ModalVoidTransaction = ({
  open,
  onOpenChange = () => {},
  title = "Void Transaction",
  onVoid,
}: ModalVoidTransactionProps) => {
        ...
        <DialogBody className="flex flex-col gap-5 py-5">
          ...
          <div className="flex flex-col items-center justify-center gap-1 px-5">
            ...
            <p className="text-slate-600 text-xs font-normal text-center">
              Once voided, this action cannot be undone.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4 pt-2.5">
            ...
            <div className="px-5">
              <Textarea
                variant="md"
                placeholder="Notes to void this transaction"
                value={notes}
...
export default ModalVoidTransaction;
