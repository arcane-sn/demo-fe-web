...
// NOTE: We assume 'useCopyToClipboard' is available here, or passed in,
// but since React Hooks can only be called inside the body of a function component,
// we will receive the `copyToClipboard` function as a prop for the columns.
// Since you want to use it directly in the cell, we must pass it in.
...
export interface AccountColumnsProps {
...
export const getAccountColumns = ({
  copyToClipboard,
}: AccountColumnsProps): ColumnDef<AccountData>[] => [
  {
    id: "userID",
    accessorKey: "userID",
    header: ({ column }) => (
