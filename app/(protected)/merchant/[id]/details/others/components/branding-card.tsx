...
import { Eye, SquareMousePointer, Image as ImageIcon } from 'lucide-react';
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded border border-gray-300 flex items-center justify-center">
                    <SquareMousePointer 
                      size={16} 
                      fill={data.brandColors.primary}
                      stroke={data.brandColors.primary}
                      strokeWidth={1}
                      style={{ opacity: 1 }}
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded border border-gray-300 flex items-center justify-center">
                    <SquareMousePointer 
                      size={16} 
                      fill={data.brandColors.secondary}
                      stroke="white"
                      strokeWidth={1}
                      style={{ opacity: 1 }}
                      className="transition-colors duration-200"
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded border border-gray-300 flex items-center justify-center">
                    <SquareMousePointer 
                      size={16} 
                      fill={data.brandColors.background}
                      stroke="white"
                      strokeWidth={1}
                      style={{ opacity: 1 }}
                      className="transition-colors duration-200"
